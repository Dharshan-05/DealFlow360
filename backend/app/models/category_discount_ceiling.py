"""Category Discount Ceiling Model (Phase 103).

Category-specific maximum discount governance entity.
"""
import uuid
...
class CategoryDiscountCeiling(Base):
    ...
    __table_args__ = (
        CheckConstraint(
            ...
            name="ck_cat_discount_ceiling_range",
        ),
        CheckConstraint(
            "effective_until IS NULL OR effective_until >= effective_from",
            name="ck_cat_discount_ceiling_effective_dates",
        ),
        Index(
            "uq_cat_discount_ceilings_active",
            "company_id",
            "category_id",
            unique=True,
